...
function AddInstallation() { 
  ...
  const generateId = async () => { 
    ...
    return `HTPS-${currentYear}-${String( 
      nextNumber 
    ).padStart(6, "0")}`; 
    ...
    try { 
      ...
      await addDoc( 
        ...
        { 
          ...
          referredByContact: 
            form.referredByContact.trim(), 
 
          technicianName: 
            form.technicianName.trim(), 
 
          technicianMobile: 
            form.technicianMobile.trim(), 
